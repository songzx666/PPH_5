# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 20:54:16 2024
...
if st.button('Predict'):
    if A4==50000 or C9==50000 or C4==50000 or D1==50000 or C3==50000 or D8==50000:
        ...
        data.columns = ['Newborn weight (grams)','First stage of labor - Latent phase(min)',
                      'Second stage of labor(min)','First stage of labor - Active phase(min)',
                      'Occupation','Premature rupture of membranes','BMI(kg/m^2)','Anemia','Third stage of labor(min)',
                      'Age (years)','Time of delivery','Analgesia during labor','Delivery (weeks)','Newborn length (centimeters)',
                      'Hypertension']
